...
use Mash\LionMail\LionCoreBundle\Adapter\SwiftMailer\SwiftMailerAdapter;
...
class SwiftMailerAdapterTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreateMessageReturnInstanceOfSwiftMessage() {
        ...
        $this->assertInstanceOf('Mash\LionMail\LionCoreBundle\Adapter\SwiftMailer\SwiftMessageAdapter', $messageCreated);
    }
